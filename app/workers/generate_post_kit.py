...
def build_writer_prompt(subject: str, profile: str, scene: str, transcript_plain: str,
    ...
    return (
        ...
        '    payoff:   names the specific concrete result or number. If the clip has no '
        'concrete result or number to name (an intro, a greeting, a scene setter), payoff '
        'must still be written: restate the forward promise of the clip instead, what the '
        'viewer is being invited into or what comes next, grounded ONLY in what is actually '
        'said or shown. Never invent a result to fill this slot.\n'
